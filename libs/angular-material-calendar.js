...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$http", "$q", "materialCalendar.Calendar", "MaterialCalendarData", function ($compile, $parse, $http, $q, Calendar, CalendarData) {
    ...
    return {
        ...
        link: function ($scope, $element, $attrs) {
            console.log($scope.disableFutureSelection);
            console.log($scope.disabledDayList);

            $scope.$watch('disabledDayList', function (val) {
                $scope.disabledDayList = val;
            });
            ...
            $scope.disabledDayList = $scope.disabledDayList || ['empty'];
            ...
            $scope.isDisabled = function (date) {
                ...
                if ($scope.disabledDayList[date.getDate()]) {
                    return true;
                }
